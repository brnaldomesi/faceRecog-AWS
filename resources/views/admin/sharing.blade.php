                ...
                <div class="portlet light">
                  <div class="portlet-title">
                    <div class="caption">
                      ...
                      <span class="caption-subject font-green-sharp bold uppercase">Data Sharing</span>
                    </div>
                  </div>
                  <div class="portlet-body">
                    ...
                    <tbody>
						...
						@foreach ($organizations as $key => $organization)
							<tr class="{{ $key % 2 > 0 ? 'odd' : 'even' }}" onClick="javascript:location.href='{{ route('admin.sharingedit.show', ['id' => $organization->id]) }}';">
								<td>{{ $key + 1 }}</td>
              					<td>
									{{ $organization->name }}
              					</td>
